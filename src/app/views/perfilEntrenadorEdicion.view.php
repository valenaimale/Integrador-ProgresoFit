...
<head>
    ...
    <script src="/assets/js/editar-perfil-entrenador.js"></script>
</head>
...
<body>
    ...
    <main>
        <div class="perfil-grid">
            ...
            <form method="POST" action="/editar-perfil" id="form-editar-perfil-entrenador" class="info-lista" novalidate>
                <fieldset>
                    ...
                    <input type="file" id="fotodeperfil" name="fotodeperfil" value="<?= htmlspecialchars($userData['fotodeperfil'] ?? '') ?>" accept="image/jpeg, image/png, image/webp">
